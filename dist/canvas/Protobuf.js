...
class Protobuf {
    static encodeRequest(track) {
        ...
        return Protobuf.EntityCanvazRequest.encode(Protobuf.EntityCanvazRequest.create({
...
Protobuf.root = protobufjs_1.Root.fromJSON({
    nested: {
        com: {
            nested: {
                spotify: {
...
Protobuf.EntityCanvazRequest = Protobuf.root.lookupType("com.spotify.canvazcache.EntityCanvazRequest");
Protobuf.EntityCanvazResponse = Protobuf.root.lookupType("com.spotify.canvazcache.EntityCanvazResponse");
