...
class Protobuf {
  static root: Root = Root.fromJSON({
    nested: {
      com: {
        nested: {
          spotify: {
  ...
  static EntityCanvazRequest = Protobuf.root.lookupType(
    "com.spotify.canvazcache.EntityCanvazRequest"
  );

  static EntityCanvazResponse = Protobuf.root.lookupType(
  ...
  static decodeResponse(buffer: Uint8Array) {
    let res;
    try {
